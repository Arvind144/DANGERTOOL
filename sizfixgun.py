...
def process_files(files_dir, guns_list, combined_excluded, longhex_dict):
    ...
    Process files in files_dir according to three branches:
      ...
      Branch 2: If file base name contains "00063" or "00064":
    ...
    """
    exception_files = {"00068678", "00068679", "00068680", "00068681"}
    ...
    for root, _, files in os.walk(files_dir):
        for file in files:
            ...
            # Branch 2: Files with "00063" or "00064" in the name → process normal hex for leveled guns only.
            elif "00063" in file_base or "00064" in file_base:
